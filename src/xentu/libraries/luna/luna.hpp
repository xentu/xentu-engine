// LunaFive (http://lua-users.org/wiki/LunaFive)
// modified register function to allow disabling of garbage collection.
#pragma once
...
public:
	...
	*/
	...
	static void Register(lua_State* L, bool gc, const char* namespac = NULL) {
	...
	*/
	// REGISTER CLASS AS A GLOBAL TABLE 
	static void RegisterConstructorless(lua_State* L, bool gc, const char* namespac = NULL) {
		luaL_newmetatable(L, T::className);
		int             metatable = lua_gettop(L);
