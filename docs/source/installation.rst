...
computer. The SDK (Software Development Kit) bundles binaries and tools that can
be access through your command line console or terminal of choice. The SDK allows
...
get setup ready to use the SDK:
...
.. toctree::
    ...
    installation/chromeos-setup
    installation/haikuos-setup

Already Installed?
------------------

If you already have the SDK installed, skip to the next step `Using The SDK <#>`_.