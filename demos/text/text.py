...
textbox.set_text(textbox3, roboto20, f"The first line measures {size1_w} x {size1_h} px")
...
def update(dt):
	...
	if stepper.next(dt):
		...
		textbox.set_text(textbox4, roboto20, f"This is a counter (1s delay): {stepper.value}")
